document.addEventListener("DOMContentLoaded", function() {
    ...
    msg.insertAdjacentElement("afterend", msg1);`.replace(/</g, "&lt;").replace(/>/g, "&gt;");
    ...
    setTimeout (() => dom.removeEventListener('mouseenter', event), 3000);`.replace(/</g, "&lt;").replace(/>/g, "&gt;");
...
msg.innerHTML = "We use cookies \u{1F36A}\u{1F923}. Please Agreee! "; // text and other child elements as innnerHTML
...
//# sourceMappingURL=index.e5368ff6.js.map
